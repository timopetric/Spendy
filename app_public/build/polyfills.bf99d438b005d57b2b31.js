                ...
                (r =
                    ...
                    typeof (o = function () {
                            ...
                            Zone.__load_patch("ZoneAwarePromise", (e, t, n) => {
                                ...
                                (I && !I.configurable) ||
                                    ...
                                    (I.set = function (t) {
                                        t === O
                                            ? (e[j] = t)
                                            : ((e[c] = t), t.prototype[l] || R(t), n.setNativePromise(t));
                                    }),
                                    r(e, "Promise", I)),
                                    (e.Promise = O);
                        ...
                        function D(n, o, r) {
                            let s = e(n, o);
                            if (
                                (!s && r && e(r, o) && (s = { enumerable: !0, configurable: !0 }),
                                !s || !s.configurable)
                            )
                                return;
                                            ...
                                            "number" == typeof r ? (s = i[r]) : ((s = r && r[ce]), s || (s = r)),
                                                s && "string" == typeof s.type
                                                    ? "notScheduled" !== s.state &&
                                                      ...
                                                      ("number" == typeof r ? delete i[r] : r && (r[ce] = null),
                                                      s.zone.cancelTask(s))
                                                    : t.apply(e, o);
                                        }
                                ));
