...
[Prikaz štroškov/prihodkov in urejenje](/public/search.html): Na tej strani lahko uporabnik pregleda odhodke in prihodke po njih išče in jih ureja.
...
[![alt text](/docs/stroski.png "Prikaz štroškov/prihodkov in urejenje")](#)

[Pregled](/public/search.html): Ta stran omogoča osnovni pregled nad aplikacijo. Torej kako gre trenutno uporabniku z varčevanjem oz zapravljanjem. Vidi se tudi Stanje na računu, zapravljen denar, tedenski budget. Ob strani so vidne tudi zadnje dejavnosti, ki jih je uporabnik zabeležil v aplikaciji. Na grafu pa je prikazan mesecni odhodek/prihodek.
[![alt text](/docs/pregled.png "Pregled")](#)
