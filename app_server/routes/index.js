...
router.get("/groups", ctrlGroups.groups).post("/groups", ctrlGroups.dodajSkupino);
router.get(["/", "/index"], ctrlIndex.index);
router.get("/login", ctrlLogin.login);
router.get("/profil", ctrlProfil.profil);
router.get("/settings", ctrlSettings.settings).post("/settings", ctrlSettings.spremeniUporabnika);
router.get("/signup", ctrlSignUp.signup).post("/signup", ctrlSignUp.registrirajUporabnika);
router
    .get("/search", ctrlSearch.seznamAktivnosti)
